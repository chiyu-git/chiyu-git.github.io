...
![image-20200511174801021](../../assets/San-Advanced/image-20200511174801021.png)
...
2. while循环读取属性
   ...
   1. `var attrMatch = walker.match(attrReg);`![image-20200512105657153](../../assets/San-Advanced/image-20200512105657153.png)

   2. `integrateAttr(aNode,"s-for'","item,i in list")`

      `parseDirective(aNode,"for","item,i in list")`![image-20200512111913214](../../assets/San-Advanced/image-20200512111913214.png)
