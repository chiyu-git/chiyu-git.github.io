...
![Render Tree](San-Advanced/render-tree.png)
...
![image-20200511174801021](San-Advanced/image-20200511174801021.png)
...
2. while循环读取属性
   ...
   1. `var attrMatch = walker.match(attrReg);`![image-20200512105657153](San-Advanced/image-20200512105657153.png)

   2. `integrateAttr(aNode,"s-for'","item,i in list")`

      `parseDirective(aNode,"for","item,i in list")`![image-20200512111913214](San-Advanced/image-20200512111913214.png)
...
2. while循环读取属性
   ...
   1. `var attrMatch = walker.match(attrReg);`![image-20200512112821931](San-Advanced/image-20200512112821931.png)
...
`preheatANode(aNode)`![image-20200513102211293](San-Advanced/image-20200513102211293.png)
...
2. ![image-20200513170615915](San-Advanced/image-20200513170615915.png)
...
ul的预热过程与h3类似，因为相关的属性都没有值![image-20200513222439739](San-Advanced/image-20200513222439739.png)

li作为ul的第一个子元素在ul的预热阶段expr.children被传入`analyseANodeHotspot(liNode)`![image-20200513224541619](San-Advanced/image-20200513224541619.png)
...
a标签作为li的第二个子元素，被传入`analyseANodeHotspot()`![image-20200514160614363](San-Advanced/image-20200514160614363.png)
...
input类型不会创建`sourceNode`![image-20200514165855766](San-Advanced/image-20200514165855766.png)
...
![image-20200514215142728](San-Advanced/image-20200514215142728.png) 
...
![Render](San-Advanced/anode-render.png)
